...
if __name__ == '__main__':
    ...
    for fold_n in range(n_fold):
        save_model_str = 'res18_bs{}_lb{}_wabs_fold{}'.format(batch_size, label_dict[label_idx], fold_n)
        ...
        # 加载训练集
        train_dataset = Lungdataset(root_dir=root_dir, dataset_dir=dataset_dir, is_train=True, label_idx=label_idx,
                                    data_subset=fold_n, is_norm=False, ct_range=(-800, 400))
        train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, **kwargs)
        # # 加载测试集
        test_dataset = Lungdataset(root_dir=root_dir, dataset_dir=dataset_dir, is_train=False, label_idx=label_idx,
                                   data_subset=fold_n, is_norm=False, ct_range=(-800, 400))
        ...
        for epoch in range(1, epoch + 1):
            ...
            max_epoch_save_model_list[fold_n] = 'Max Auc: {}; Epoch: {}; Save: {}'.format(max_auc, max_epoch, save_model_str)
